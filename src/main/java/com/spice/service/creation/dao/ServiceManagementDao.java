...
public class ServiceManagementDao {
	...
	public CallableStatement updatesServiceStatus(ServiceStatus serviceStatus)
			throws Exception {
	...
	public CallableStatement createService(
			CreateServiceRequest createServiceRequest, String userId)
			throws Exception {
		...
		try {
			...
			stmt.setString("in_parent_service_id",
					createServiceRequest.getParentServiceId());
			...
			stmt.setString("in_subscriber_type",
					createServiceRequest.getSubscriberType());
	...
	public List<SingleServiceNodeReponse> getSingleServiceNode(String parentId,
			String serviceId) throws Exception {
		String str = "Call proc_get_single_service_node(?,?)";
		return jdbcTemplateObject.query(str, new Object[] { parentId, serviceId },
				new SingleServiceNodeReponse());
	}

	public CallableStatement createServiceNode(
			CreateServiceNode createServiceNode, String userId) throws Exception {
		...
		try {
			...
			stmt.setString("in_invalid_response_text",
					createServiceNode.getInvalidResponseText());
			stmt.setString("in_invalid_menu_flag",
					createServiceNode.getInvalidMenuFlag());
			...
			stmt.setString("in_switch_service_id",
					createServiceNode.getSwitchServiceId());
			stmt.setString("in_switch_service_code",
					createServiceNode.getServiceCode());
	...
	public CallableStatement updateService(
			UpdateServiceRequest updateServiceRequest, String userId)
			throws Exception {
		...
		try {
			...
			stmt.setString("in_invalid_response_text",
					updateServiceRequest.getInvalidResponseText());
			stmt.setString("in_invalid_menu_flag",
					updateServiceRequest.getInvalidMenuFlag());
			...
			stmt.setString("in_is_list_element",
					updateServiceRequest.getIsListElement());
			...
			stmt.setString("in_application_id",
					updateServiceRequest.getApplicationId());
			stmt.setString("in_variable_name", updateServiceRequest.getVariableName());
			stmt.setString("in_variable_value",
					updateServiceRequest.getVariableValue());
			stmt.setString("in_switch_service_id",
					updateServiceRequest.getSwitchServiceId());
			stmt.setString("in_switch_service_code",
					updateServiceRequest.getSwitchServiceCode());
			...
			stmt.setString("in_if_value_clause",
					updateServiceRequest.getIfValueClause());
	...
	public CallableStatement updateNodeStatus(
			UpdateNodeStatusRequest updateNodeStatusRequest, String userId)
			throws Exception {
	...
	public CallableStatement createServiceMaster(
			CreateServiceMasterRequest createServiceMasterRequest, String userId)
			throws Exception {
		String str = "{call proc_create_service_master(?,?,?,?,?,?,?,?,?,?,?)}";
		Connection conn = null;
		try {
			...
			CallableStatement stmt = conn.prepareCall(str);
			stmt.setString("in_login_id", userId);
			stmt.setInt("in_creation_mode",
					Integer.parseInt(createServiceMasterRequest.getCreationMode()));
			stmt.setString("in_source_service_id",
					createServiceMasterRequest.getSourceServiceId());
			stmt.setString("in_parent_service_id",
					createServiceMasterRequest.getParentServiceId());
			stmt.setString("in_service_name",
					createServiceMasterRequest.getServiceName());
			stmt.setString("in_service_code",
					createServiceMasterRequest.getServiceCode());
			stmt.setString("in_description",
					createServiceMasterRequest.getDescription());
	...
	public CallableStatement commitService(
			CommitServiceRequest commitServiceRequest, String userId)
			throws Exception {
		
		String str = "{call proc_commit_service(?,?,?,?,?,?,?)}";
		Connection conn = null;
		try {
			System.out.println("call proc_commit_service("+userId+","+commitServiceRequest.getVersionType()+","+commitServiceRequest.getServiceId()+","+commitServiceRequest.getRemarks()+",?,?,?)");
		  ...
		  /*stmt.setInt(1, Integer.parseInt(userId));
			System.out.println("1 ----"+ Integer.parseInt(userId));

			stmt.setString(2, commitServiceRequest.getVersionType());
			System.out.println("2 ----"+commitServiceRequest.getVersionType());

			stmt.setInt(3, Integer.parseInt(commitServiceRequest.getServiceId()));
			System.out.println("3 ----"+commitServiceRequest.getServiceId());
			stmt.setString(4, commitServiceRequest.getRemarks());
			System.out.println("4 ----"+commitServiceRequest.getRemarks());*/
	...
	public CallableStatement editService(EditServiceRequest editServiceRequest,
	...
	public List<ServiceListResponse> serviceList(
			ServiceListRequest serviceListRequest, String userId) throws Exception {
		String str = "call proc_get_service_list(?,?)";
		return jdbcTemplateObject.query(str, new Object[] { userId,
				serviceListRequest.getParentId() }, new ServiceListResponse());
	}

	public CallableStatement updateServiceDetail(
			UpdateServiceDetailRequest updateServiceDetailRequest, String userId)
			throws Exception {
		...
		try {
			...
			stmt.setString("in_login_id", userId);
			stmt.setString("in_description",
					updateServiceDetailRequest.getDescription());
			stmt.setString("in_service_id", updateServiceDetailRequest.getServiceId());
			stmt.setString("in_service_name",
					updateServiceDetailRequest.getServiceName());
	...
	public CallableStatement cancelEditService(
			CancelEditServiceRequest cancelEditServiceRequest, String userId)
			throws Exception {
	...
	public CallableStatement fetchServiceDetail(
			FetchServiceDetailRequest fetchServiceDetailRequest, String userId)
			throws Exception {
	...
	public List<ServiceRevisionResponse> serviceRevision(String loginId)
			throws Exception {
		String str = "Call proc_view_service_revision_history(?)";
		return jdbcTemplateObject.query(str, new Object[] { loginId },
				new ServiceRevisionResponse());
	}

	public List<ViewEditServiceResponse> viewEditService(String loginId)
			throws Exception {
		String str = "Call proc_view_edit_service_history(?)";
		return jdbcTemplateObject.query(str, new Object[] { loginId },
				new ViewEditServiceResponse());
	}

	public CallableStatement revokeRevisionService(
			RevokeRevisionRequest revokeRevisionRequest, String userId)
			throws Exception {
		...
		try {
			...
			stmt.setString("in_version_major",
					revokeRevisionRequest.getVersionMajor());
			stmt.setString("in_version_minor",
					revokeRevisionRequest.getVersionMinor());
	...
	public CallableStatement linkServiceNode(
			LinkServiceNodeRequest linkServiceNodeRequest, String userId)
			throws Exception {
		...
		try {
			...
			stmt.setString("in_source_node_id",
					linkServiceNodeRequest.getSourceNodeId());
	...
	public static void main(String args[]) throws Exception{
		ServiceManagementDao obj = new ServiceManagementDao();
		CommitServiceRequest commit =new CommitServiceRequest();
		commit.setRemarks("Minor");
		commit.setServiceId("384");
		commit.setVersionType("Minor");
		obj.commitService(commit,"1");
